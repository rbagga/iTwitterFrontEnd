...
const Login = ({ classes, ...props }) => (
  <Grid container className={classes.container}>
    <div className={classes.logotypeContainer}>
      ...
      <Typography className={classes.logotypeText}>iTwitter</Typography>
    </div>
          ...
          <React.Fragment>
            ...
            <div className={classes.creatingButtonContainer}>
              {props.isLoading ? (
                ...
                <Button
                  onClick={() => {props.createAccount(props.firstNameValue, props.nameValue, props.loginValue, props.passwordValue)}}
                  disabled={
                    props.loginValue.length === 0 ||
                    props.passwordValue.length === 0 ||
